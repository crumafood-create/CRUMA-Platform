    ...
    <section className="bg-[#173b2f] px-5 py-16 text-white lg:px-8 lg:py-24">
      <div className="mx-auto max-w-7xl">
        ...
        <p className="mt-6 max-w-2xl text-lg leading-8 text-white/70">
          Conoce nuestras líneas y presentaciones. La disponibilidad se confirma al preparar tu pedido.
        </p>
      </div>
    </section>
  );
...
function WholesaleSection() {
  return (
    <section id="mayoreo" className="scroll-mt-24 px-5 pb-20 lg:px-8">
