...
Antes de autorizar cualquier reparaci�n remota, ejecutar:
...
La ejecuci�n verificada el 2026-08-18 produjo:

- `LEDGER_BEFORE=ABSENT`;
- `REMOTE_VERSION_COUNT=7`;
- `PUBLIC_SCHEMA_MATCH=OK`;
- SHA-256 del esquema p�blico
  `d7588443a96f968eceb8e92dbe55b26a4cc16708f4b43ad2cae66ea0e93d3b7e`;
- `REHEARSAL_DATABASE_REMAINING=0` despu�s de la limpieza.

Preparación: [autorización de reconciliación](./production-migration-reconciliation-authorization.md).
## Reversión
