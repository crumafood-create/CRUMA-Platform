...
> **CRUMAFOOD conservará sus decisiones como parte del producto. Un ADR permitirá comprender no solo qué arquitectura existe, sino por qué fue elegida, qué costo aceptó y cuándo deberá reconsiderarse.**# Architecture Decision Records de CRUMAFOOD Platform
...
1. roles, permisos y scopes;
2. topología Desktop con Tauri;
3. estrategia offline;
4. eventos, outbox e inbox;
5. pipeline CI/CD;
6. proveedor de observabilidad;
7. SLO, RPO y RTO;
8. estrategia de caché;
9. formato canónico de design tokens;
10. Storybook y pruebas visuales;
11. gestor de paquetes y versión de Node;
12. separación de proyectos Supabase por entorno;
13. estrategia de backups y restauración.
